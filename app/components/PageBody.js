  ...
  render: function(){
    return (
      ...
      <Alert bsStyle="danger">
          ...
          <h2 className="text-center">Kronos is DOWN!</h2>
          <p className="text-center">Kronos is now experiencing issues after the server move. Keep your eyes peeled here for live updates to the server status. </p>
          <Row>
          <Col xs={4} xsOffset={8}>
