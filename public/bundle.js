...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'a',
	            { href: 'https://forum.nostalrius.org/viewtopic.php?f=2&t=44103', target: '_new_win' },
	            'Why not fill in the Nostalrius Legacy Servers survey? »'
	          )
	        )
	      )
	    );
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'result' },
	        React.createElement('img', { src: "img/" + this.state.source, alt: 'Kronos is DOWN!' }),
	        React.createElement(
	          'h1',
	          null,
	          'No, Kronos is ',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'result' },
	        React.createElement('img', { src: "img/" + this.state.source, alt: 'Kronos is UP!' }),
	        React.createElement(
	          'h1',
	          null,
	          'Kronos is back up and fully operational.'
	        )
	      )
	    );
	  }
	...
	ReactDOM.render(React.createElement(Disclaimer, null), document.getElementById('disclaimer'));
